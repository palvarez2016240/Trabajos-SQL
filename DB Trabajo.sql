...
delimiter ;
#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
call sp_AgregarRegiones ('Central');
...
call sp_AgregarCategorias ('Epleado', 50000);
...
select nombre , fn_Porcentaje(c.salario, i.fechaContratacion) as Sueldo from categorias c, informe i
where c.id_categorias = i. id_categorias;


select categorias.Nombre, informe.fn_Porcentaje(c.salario, i.fechaContratacion) from categorias c inner join informe i on 
c.categorias = i.categorias;

#------------------------------------------------------------------------------------------------------------------------------------------------------------
select e.nombre as Nombre, e.apellido as Apellido,i.fechaContratacion as Contratacion from informe i, empleados e 
where i.DPI = e.DPI;
#----------------------------------------------------------------------------------------------------------------------------------------------------------
select count(Nombre) as Cuantos, fn_Edad(FechaNacimiento) as Edad from empleados e right join informe i on e.DPI = i.DPI;
#-----------------------------------------------------------------------------------------------------------------------------------------------------------
#11
...
#----------------------------------------------------------------------------------------------------------------------------------------------------------------
#24
select e.nombre as 'Jefes de Seccion' from empleados e inner join categorias c inner join informe i on e.DPI = i.DPI
and c.id_categorias = i.id_categorias 
and c.id_categorias = 2
